...
The bracket abstraction compiler and simulation properties in this section are mechanically verified in \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/LambdaFragment.lean}{\texttt{src/ISAR/LambdaFragment.lean}}. We define the standard $\lambda$-calculus with de Bruijn indices.
...
The set-theoretic encoding and relative ZFC interpretation verified in this section are mechanically verified in \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/HFSet.lean}{\texttt{src/ISAR/HFSet.lean}}, \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/HFSetEncoding.lean}{\texttt{src/ISAR/HFSetEncoding.lean}}, and \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/HFSetSemantics.lean}{\texttt{src/ISAR/HFSetSemantics.lean}}. This relative interpretation is strictly limited to the Hereditarily Finite (HF) set fragment (ZFC without the axiom of infinity). We formalize HF Sets, their encoding, and show they satisfy set-theoretic axioms.
...
The SKI TRS view, stack bytecode compiler, and Barker's iota dialect are verified in \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/TRSView.lean}{\texttt{src/ISAR/TRSView.lean}}, \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/BytecodeView.lean}{\texttt{src/ISAR/BytecodeView.lean}}, and \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/IotaView.lean}{\texttt{src/ISAR/IotaView.lean}} respectively. We define dialects for other standard computational models.
