...
The definitions and structures in this section are mechanically verified in \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/KernelCategory.lean}{\texttt{src/ISAR/KernelCategory.lean}} and \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/DialectKernel.lean}{\texttt{src/ISAR/DialectKernel.lean}}. We define the category $\mathcal{K}$ of admissible semantic kernels over the substrate.
...
The uniqueness and terminality theorems are formalized and proved in \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/KernelCategory.lean}{\texttt{src/ISAR/KernelCategory.lean}}. We prove that the canonical representation-free kernel is terminal, meaning that any admissible view can be uniquely decoded into it.
...
The Dialect structures in this section are verified in \href{https://github.com/cypoe/isar-proofs/blob/master/src/ISAR/DialectKernel.lean}{\texttt{src/ISAR/DialectKernel.lean}}. A Dialect is an alternative abstract view over the substrate.
